...
import org.chenile.samples.securityauth.servicea.context.RequestSecurityContextFilter;
...
public class SecurityConfig {
    ...
    ResourceAuditService resourceAuditService(MeterRegistry meterRegistry) {
        return new ResourceAuditService(
                ...
                "SERVICE_A_AUDIT",
                "service-a",
                "chenile.security.service_a.token.failure");
    }
    ...
    SecurityFilterChain securityFilterChain(
        ...
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/a/orders/**").hasAuthority("SCOPE_service-a.read")
    ...
    JwtIssuerAuthenticationManagerResolver jwtIssuerAuthenticationManagerResolver(
        ...
        return authenticationManagerFactory.createResolver(issuerBase, jwkBaseUri, "service-a");
    }
}
