package org.chenile.samples.securityauth.servicea.context;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (authentication instanceof JwtAuthenticationToken jwtAuthenticationToken) {
            ...
            String userId = JwtClaimUtils.firstNonBlank(
                    ...
                    "unknown");
            List<String> acls = JwtClaimUtils.extractAcls(jwtAuthenticationToken);
            List<String> headerAcls = JwtClaimUtils.splitHeaderValues(request.getHeader("x-acls"));
